...
from OTPConvertColor import OTPConvertColor

class OTModuleConvertColors(OTModulePlugin,OTModuleInputVideoPipe,OTPConvertColor):
    ...
    def processFrame(self, frame):
        filtered = OTPConvertColor.compute(self, frame)
